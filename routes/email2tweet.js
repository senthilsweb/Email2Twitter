...
exports.startProcessEmail = function(req, res) {
     //send the response
   console.log("Starting.....")
   new cronJob(config.cron.schedule, function () {
     setTimeout(function(){ProcessEmail();},0);
   }, null, true, "America/Los_Angeles");
    res.send({"result" : "Starting"});
    }

exports.stopProcessEmail = function(req, res) {
      //send the response
   console.log("Stopping.....")
    res.send({"result" : "Stopping"});
    }

exports.emailToTweet = function(req, res) {
  setTimeout(function(){ProcessEmail();},0);
     //send the response
   console.log("Process Email Starting.....")
   res.send({"result" : "success"});
}

function ProcessEmail() {
    
    console.log("inside email2tweet")
